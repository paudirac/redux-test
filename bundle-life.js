...
/***/ function(module, exports, __webpack_require__) {
	...
	function neighbourCount(index, state) {
	    var count = neighbours[index].map(function (i) {
	        return state[i];
	    }).reduce(function (i, a) {
	        return i + a;
	    }, 0);
	...
	function conway(_ref) {
	    ...
	    switch (current) {
	        case 1:
	            if (counts <= 1) return 0;else if (counts === 2 || counts === 3) return 1;else if (counts >= 4) return 0;
	        case 0:
	            if (counts === 3) return 1;else return 0;
	    }
	}

	var initialState = randomState();
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        case ACTION_MUTATE:
	            var counts = state.map(function (s, i) {
